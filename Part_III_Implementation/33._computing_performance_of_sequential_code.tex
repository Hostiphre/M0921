...
totally exist, but of the same form, depending on the algorithm of FFT %Is this sentence trying to say there is a dependence on the FFT algorithm?
{[}ref dft{]}. It should be noted that a grid of prime number is always
at the peaks in the figure, which means il can be 2 or more times longer %il? What is il?
...
with $\mu\geq0$, it is also different. %'it is also different' makes no sense.
