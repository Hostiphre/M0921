...
charges also have difficulty converging), and all the converged results
are presented.}
...
it is converted to give better understanding. }
...
From the above results, the following initial conclusions may be drawn:
\begin{itemize}
