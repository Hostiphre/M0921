...
We can hypothesize that this error depends on the angular
...
comparison with IET is done for three charges, 0, -0.6 and +1, shown %Is this +1 or -1? You have both in this paragraph.
...
From the results, we see that MDFT ... ``capable'' to produce the %Is this paragraph unfinished?
