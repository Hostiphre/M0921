...
Molecule 1 and 2 in different coordinate systems\foreignlanguage{english}{\label{fig:coordinate_systems}}\selectlanguage{american}%
}
\end{figure}
...
As shown in figure \ref{fig:rotation-matrices}, the rotation matrix
...
Then, the elements of $\mathbf{\hat{R}}_{\boldsymbol{\omega}}$ can
