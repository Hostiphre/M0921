...
In this way, the integral of the angular part in eq. (\ref{eq:gamma-k})
...
\textcolor{red}{(All those operations have commutativity properties
...
\textcolor{blue}{(But I just can't deduce it !!!!! )}\textcolor{red}{
\begin{equation}
