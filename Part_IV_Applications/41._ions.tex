...
The comparison of \acs{RDF} with \acs{MD} results are shown in figure
...
on SPC/E water as shown also in table \ref{tab:single-ions}. \marginpar{\textcolor{red}{We consider that for a macroscopic system, when the
number of particles $N\rightarrow\infty$, the Gibbs and Helmholtz
free energy are almost the same. }\citep{ensemble_thermo}}
