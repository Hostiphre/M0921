...
\ctparttext{In chapter III, we've studied the numerical accuracy of the code
comparing to \acs{IET}. In this section, we are interested in the
physical accuracy comparing to \acs{MD} and experimental results.
A few applications are made in this purpose in section \ref{chpt:ions},
containing some LJ centers, ions and small molecules. The results
are also compared to dipole reference method, to show that this increase
of computing cost has really done an improvement on the results.}
...
\medskip{}
The goal of the current work was ...\\
\medskip{}
The following results were achieved in the current research project:\\
\medskip{}
The performed tests show that the proposed methods are suitable for
fast and accurate calculations of solvation free energies...}
