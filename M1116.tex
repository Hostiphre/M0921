...
really done an improvement on the results.}
...
within the development of \acf{MDFT} presented so far. The approach
is yet limited to rigid molecules and the neglect of three-body correlations.\\
\medskip{}
To complete this story, we conclude all the achievements done in this
thesis, and some unfinished work and theories linked to this thesis
